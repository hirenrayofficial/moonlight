  ...
  return (
    <div className="sr-root">
      <style>{`
        ...
        .sr-logo { display: flex; align-items: center; gap: 10px; }
        .sr-logo-mark {
          width: 22px;
          height: 22px;
          background: var(--ink);
        ...
        .sr-nav-links { display: flex; align-items: center; gap: 26px; }
        .sr-nav-link {
          font-family: 'IBM Plex Mono', monospace;
          font-size: 11px;
        ...
        .sr-nav-link:hover { color: var(--ink); border-color: var(--line-strong); }
        .sr-nav-cta {
          font-family: 'IBM Plex Mono', monospace;
          font-size: 11px;
          letter-spacing: 0.08em;
        ...
        .sr-nav-cta:hover { background: var(--bg); color: var(--ink); }
        @media (max-width: 720px) { .sr-nav-links { display: none; } }
        ...
        .sr-hero-left {
          padding: 76px 48px 76px 32px;
          border-right: 1px solid var(--line-strong);
        }
        @media (max-width: 900px) {
          .sr-hero-left { border-right: none; border-bottom: 1px solid var(--line-strong); padding: 56px 24px; }
        }
        ...
        .sr-btn-primary:hover { background: var(--accent); color: var(--accent-ink); border-color: var(--accent); }
        .sr-btn-secondary {
          font-family: 'IBM Plex Mono', monospace;
          font-size: 12px;
          letter-spacing: 0.06em;
        ...
        /* ---------- product showcase (signature element) ---------- */
        .sr-hero-right {
          padding: 40px 32px;
          display: flex;
          align-items: center;
        ...
        @media (max-width: 900px) { .sr-hero-right { padding: 40px 24px 56px; } }
        ...
        @media (max-width: 720px) { .sr-ledger { grid-template-columns: repeat(2, 1fr); } }
        .sr-ledger-cell {
          padding: 28px 26px;
          border-right: 1px solid var(--line-strong);
        }
        .sr-ledger-cell:last-child { border-right: none; }
        @media (max-width: 720px) {
          .sr-ledger-cell:nth-child(2n) { border-right: none; }
          .sr-ledger-cell:nth-child(-n+2) { border-bottom: 1px solid var(--line-strong); }
        }
        .sr-ledger-label {
          font-size: 10.5px;
          letter-spacing: 0.1em;
