...
const REVIEWS = [
  ...
  {
    name: "M. Alvarez",
    product: "Canvas work apron",
    rating: 4,
    date: "2026-05-02",
    verified: true,
    text: "Strap could be an inch longer but the fabric is genuinely thick. Survived a grinder spark test I didn't mean to run.",
  },
  {
    name: "T. Whitfield",
    product: "Waxed canvas tool roll",
    rating: 5,
    date: "2026-04-21",
    verified: true,
    text: "Fits more than the product photo suggests. Wax finish hasn't cracked after three months in a truck bed.",
  },
  {
    name: "S. Kapoor",
    product: "Chef's knife, 8in carbon steel",
    rating: 5,
    date: "2026-04-09",
    verified: true,
    text: "Took an edge better than knives twice the price. Needs a strop more often than stainless — expected, not a complaint.",
  },
  {
    name: "D. Novak",
    product: "Work boots, steel toe",
    rating: 4,
    date: "2026-03-27",
    verified: false,
    text: "Break-in period is real, about two weeks. After that, better ankle support than my last three pairs combined.",
  },
  {
    name: "J. Farrow",
    product: "Stainless prep bowls, set/3",
    rating: 5,
    date: "2026-03-15",
    verified: true,
    text: "Nested storage actually nests. Small thing, but it's the reason I stopped using my old plastic set.",
  },
];
